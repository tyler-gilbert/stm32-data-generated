...
# [inline (always)]
pub const fn cr (self) -> crate :: common :: Reg < regs :: Cr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0usize) as _) } } # [doc = "Status register"]
# [inline (always)]
pub const fn sr (self) -> crate :: common :: Reg < regs :: Sr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (4usize) as _) } } # [doc = "Data input register"]
# [inline (always)]
pub const fn dinr (self) -> crate :: common :: Reg < regs :: Dinr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize) as _) } } # [doc = "Data output register"]
# [inline (always)]
pub const fn doutr (self) -> crate :: common :: Reg < regs :: Doutr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (12usize) as _) } } # [doc = "Key register"]
# [inline (always)]
pub const fn keyr (self , n : usize) -> crate :: common :: Reg < regs :: Keyr , crate :: common :: RW > { assert ! (n < 8usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (16usize + ([0usize , 4usize , 8usize , 12usize , 32usize , 36usize , 40usize , 44usize]
[n]
as usize)) as _) } } # [doc = "Initialization vector register"]
# [inline (always)]
pub const fn ivr (self , n : usize) -> crate :: common :: Reg < regs :: Ivr , crate :: common :: RW > { assert ! (n < 4usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (32usize + n * 4usize) as _) } } # [doc = "Suspend register"]
# [inline (always)]
pub const fn suspr (self , n : usize) -> crate :: common :: Reg < regs :: Suspr , crate :: common :: RW > { assert ! (n < 8usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (64usize + n * 4usize) as _) } } # [doc = "interrupt enable register"]
# [inline (always)]
pub const fn ier (self) -> crate :: common :: Reg < regs :: Ier , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (768usize) as _) } } # [doc = "interrupt status register"]
# [inline (always)]
pub const fn isr (self) -> crate :: common :: Reg < regs :: Isr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (772usize) as _) } } # [doc = "interrupt clear register"]
# [inline (always)]
pub const fn icr (self) -> crate :: common :: Reg < regs :: Icr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (776usize) as _) } } } pub mod regs { # [doc = "Control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_chmod10 (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x03 << 5usize)) | (((val as u32) & 0x03) << 5usize) ; } # [doc = "Enable DMA management of data input phase"]
# [inline (always)]
...
fn default () -> Doutr { Doutr (0) } } # [doc = "Interrupt clear register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Isr { Isr (0) } } # [doc = "Initialization vector register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
MODE1 = 0 , # [doc = "Key derivation (or key preparation for ECB/CBC decryption)"]
