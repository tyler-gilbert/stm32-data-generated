...
# [inline (always)]
pub const fn cfgr3 (self) -> crate :: common :: Reg < regs :: Cfgr3 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (48usize) as _) } } # [doc = "Clock control register 2"]
# [inline (always)]
pub const fn cr2 (self) -> crate :: common :: Reg < regs :: Cr2 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (52usize) as _) } } } pub mod regs { # [doc = "AHB Peripheral Clock enable register (RCC_AHBENR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_pllsrc (& mut self , val : super :: vals :: Pllsrc) { self . 0 = (self . 0 & ! (0x03 << 15usize)) | (((val . to_bits () as u32) & 0x03) << 15usize) ; } # [doc = "HSE divider for PLL entry. Same bit as PREDIC\\[0\\]
from CFGR2 register. Refer to it for its meaning"]
# [inline (always)]
pub const fn pllxtpre (& self) -> super :: vals :: Pllxtpre { let val = (self . 0 >> 17usize) & 0x01 ; super :: vals :: Pllxtpre :: from_bits (val as u8) } # [doc = "HSE divider for PLL entry. Same bit as PREDIC\\[0\\]
from CFGR2 register. Refer to it for its meaning"]
# [inline (always)]
...
NOMCO = 0 , # [doc = "Internal RC 14 MHz (HSI14) oscillator clock selected"]
...
HSI_DIV2 = 0 , # [doc = "NOT ALLOWED IN F0x0 - HSI divided by PREDIV selected as PLL input clock"]
HSI_DIV_PREDIV = 0x01 , # [doc = "HSE divided by PREDIV selected as PLL input clock"]
HSE_DIV_PREDIV = 0x02 , # [doc = "NOT ALLOWED IN F0x0 - HSI48 divided by PREDIV selected as PLL input clock"]
...
PLL1_P = 0x02 , # [doc = "HSI48 used as system clock (when avaiable)"]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Usbsw { # [doc = "NOT ALLOWED IN F0x0 - HSI48 selected as USB clock source"]
HSI48 = 0 , # [doc = "PLL clock selected as USB clock source"]
