...
# [inline (always)]
pub const fn cr (self) -> crate :: common :: Reg < regs :: Cr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0usize) as _) } } # [doc = "Clock configuration register (RCC_CFGR)"]
# [inline (always)]
pub const fn cfgr (self) -> crate :: common :: Reg < regs :: Cfgr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (4usize) as _) } } # [doc = "Clock interrupt register (RCC_CIR)"]
# [inline (always)]
pub const fn cir (self) -> crate :: common :: Reg < regs :: Cir , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (8usize) as _) } } # [doc = "APB2 peripheral reset register (RCC_APB2RSTR)"]
# [inline (always)]
pub const fn apb2rstr (self) -> crate :: common :: Reg < regs :: Apb2rstr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (12usize) as _) } } # [doc = "APB1 peripheral reset register (RCC_APB1RSTR)"]
# [inline (always)]
pub const fn apb1rstr (self) -> crate :: common :: Reg < regs :: Apb1rstr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (16usize) as _) } } # [doc = "AHB Peripheral Clock enable register (RCC_AHBENR)"]
# [inline (always)]
pub const fn ahbenr (self) -> crate :: common :: Reg < regs :: Ahbenr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (20usize) as _) } } # [doc = "APB2 peripheral clock enable register (RCC_APB2ENR)"]
# [inline (always)]
pub const fn apb2enr (self) -> crate :: common :: Reg < regs :: Apb2enr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (24usize) as _) } } # [doc = "APB1 peripheral clock enable register (RCC_APB1ENR)"]
# [inline (always)]
pub const fn apb1enr (self) -> crate :: common :: Reg < regs :: Apb1enr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (28usize) as _) } } # [doc = "Backup domain control register (RCC_BDCR)"]
# [inline (always)]
pub const fn bdcr (self) -> crate :: common :: Reg < regs :: Bdcr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (32usize) as _) } } # [doc = "Control/status register (RCC_CSR)"]
# [inline (always)]
pub const fn csr (self) -> crate :: common :: Reg < regs :: Csr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (36usize) as _) } } # [doc = "AHB peripheral reset register"]
# [inline (always)]
pub const fn ahbrstr (self) -> crate :: common :: Reg < regs :: Ahbrstr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (40usize) as _) } } # [doc = "Clock configuration register 2"]
# [inline (always)]
pub const fn cfgr2 (self) -> crate :: common :: Reg < regs :: Cfgr2 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (44usize) as _) } } # [doc = "Clock configuration register 3"]
# [inline (always)]
pub const fn cfgr3 (self) -> crate :: common :: Reg < regs :: Cfgr3 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (48usize) as _) } } } pub mod regs { # [doc = "AHB Peripheral Clock enable register (RCC_AHBENR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_pllsrc (& mut self , val : super :: vals :: Pllsrc) { self . 0 = (self . 0 & ! (0x03 << 15usize)) | (((val . to_bits () as u32) & 0x03) << 15usize) ; } # [doc = "HSE divider for PLL entry"]
# [inline (always)]
...
# [inline (always)]
pub fn set_sdpre (& mut self , val : super :: vals :: Sdpre) { self . 0 = (self . 0 & ! (0x1f << 27usize)) | (((val . to_bits () as u32) & 0x1f) << 27usize) ; } # [doc = "Microcontroller Clock Output Prescaler"]
# [inline (always)]
...
# [inline (always)]
pub const fn usart1sw (& self) -> super :: vals :: Usartsw { let val = (self . 0 >> 0usize) & 0x03 ; super :: vals :: Usartsw :: from_bits (val as u8) } # [doc = "USART1 clock source selection"]
# [inline (always)]
pub fn set_usart1sw (& mut self , val : super :: vals :: Usartsw) { self . 0 = (self . 0 & ! (0x03 << 0usize)) | (((val . to_bits () as u32) & 0x03) << 0usize) ; } # [doc = "I2C1 clock source selection"]
# [inline (always)]
...
# [inline (always)]
pub const fn tim2sw (& self) -> super :: vals :: Timsw { let val = (self . 0 >> 24usize) & 0x01 ; super :: vals :: Timsw :: from_bits (val as u8) } # [doc = "Timer2 clock source selection"]
# [inline (always)]
pub fn set_tim2sw (& mut self , val : super :: vals :: Timsw) { self . 0 = (self . 0 & ! (0x01 << 24usize)) | (((val . to_bits () as u32) & 0x01) << 24usize) ; } # [doc = "Timer34 clock source selection"]
# [inline (always)]
...
HSI_DIV_244 = 0 , # [doc = "LSE clock selected as CEC clock source"]
...
HSI = 0 , # [doc = "SYSCLK clock selected as I2C clock source"]
...
SYS = 0 , # [doc = "External clock mapped on the I2S_CKIN pin used as I2S clock source"]
...
DIV1 = 0 , # [doc = "MCO is divided by 2"]
...
DISABLE = 0 , _RESERVED_1 = 0x01 , # [doc = "Internal low speed (LSI) oscillator clock selected"]
...
DIV2 = 0 , # [doc = "PLL is not divided for MCO"]
...
HSI_DIV2 = 0 , # [doc = "HSI divided by PREDIV selected as PLL input clock"]
...
DIV1 = 0 , # [doc = "HSE clock divided by 2"]
...
DIV1 = 0 , # [doc = "PREDIV input clock divided by 2"]
...
PCLK2_TIM = 0 , # [doc = "PLL vco output (running up to 144 MHz)"]
...
PCLK1 = 0 , # [doc = "SYSCLK selected as USART clock source"]
...
DIV1_5 = 0 , # [doc = "PLL clock is not divided"]
